...
(function() {
  ...
  const SCRIPT_VERSION = 'v5.4';  // 版本标识：标题栏可见 + console 输出，用于确认加载的是最新文件
...
@media (max-width: 720px) {
  ...
  .agent-main.swiping .agent-panels { transition: none; }  /* 跟手时去掉过渡 */
  ...
  <header class="agent-header">
    <div class="agent-title">
      ...
      <div class="agent-title-text">
        <h1>小说续写 Agent <span style="opacity:.45;font-size:11px;font-weight:400;letter-spacing:.3px;">v5.4</span></h1>
