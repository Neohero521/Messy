...
@media (hover: none) and (pointer: coarse) {
  ...
  .agent-more-menu button:hover { background: initial; color: initial; border-color: initial; }
...
@media (max-width: 720px) {
  ...
  /* ---------- 中央主区 / Tab （移动端体验优化：胶囊式分段控件） ---------- */
  .agent-tabs {
    padding: 8px 12px;
    gap: 8px; /* 给每个Tab之间留出呼吸感 */
  ...
  .agent-tab {
    flex: 1; /* 均分宽度 */
    justify-content: center;
    padding: 10px 0; /* 增加上下点击区域，左右交由flex控制 */
    font-size: 13.5px;
  ...
  .agent-tab:active {
    transform: scale(0.96); /* 增加按压回馈，提升触感 */
  }
  .agent-tab svg {
    width: 16px;
    height: 16px;
